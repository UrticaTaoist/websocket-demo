package cn.luutqf.spring.websocket.server.controller;
...
//    @Autowired
//    public WebSocketServer(RedisTemplate<String, Object> redisTemplate) {
...
//        redisTemplate.opsForValue().set(sid,this);
        addOnlineCount();           //在线数加1
        log.info("有新窗口开始监听:" + sid + ",当前在线人数为" + webSocketMap.size());
        this.sid = sid;
        System.out.println("用户ID为:" + sid);
        try {
            sendMessage("连接成功");
        } catch (IOException e) {
